...
let NotificationController = class NotificationController {
    ...
    async getNotifications(page = 1, limit = 20, request) {
        return this.notificationService.getNotifications(request.user.id, {
            page,
            limit
        });
    }
    async getNewNotifications(page = 1, limit = 5, request) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], NotificationController.prototype, "getNewNotifications", null);
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthenticationGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Patch)('/:id'),
